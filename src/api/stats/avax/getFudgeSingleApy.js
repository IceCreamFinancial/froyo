...
const MasterChef = require('../../../abis/avax/SundaeRewardPool.json');
const pools = require('../../../data/avax/sundaePool.json');
const fetchPrice = require('../../../utils/fetchPrice');
const { getTotalStakedInUsd } = require('../../../utils/getTotalStakedInUsd');
const { compound } = require('../../../utils/compound');

const masterchef = '0x2971aB78F17dC8EA57718D6D9b2385791029b288';
const oracle = 'tokens';
const oracleId = 'STRAW';

const DECIMALS = '1e18';
const CHAIN_ID = 43114;
const secondsPerYear = 31536000;

const getFudgeSingleApy = async () => {
  let apys = {};
...
module.exports = getFudgeSingleApy;
